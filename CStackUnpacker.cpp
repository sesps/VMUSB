...
//--ddc sep12 add stuff for 'marker'
...
static CMARKERUnpacker    unpackMarker;
...
CModuleUnpacker* CStackUnpacker::m_unpackers[] = 
  {
    ...
    &unpackHINP,
    &unpackPSD,
    &unpackMarker               // Make the 'marker' the LAST 'type'
};
//--ddc Make sure that the 'device type' index here,  for "marker"
//is properly put into the tcl script that builds the stack.
